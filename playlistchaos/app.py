...
def profile_sidebar():
    ...
    # Fix: default the selectbox to the genre already stored in the profile
    # instead of hardcoding index=0, which silently reset it to "rock" on every
    # rerun and discarded the user's choice.
